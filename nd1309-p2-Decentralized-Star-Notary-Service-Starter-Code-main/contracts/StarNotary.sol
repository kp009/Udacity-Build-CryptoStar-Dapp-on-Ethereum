...
contract StarNotary is ERC721 {
    ...
    string public name = "TestStarToken";
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require(ownerOf(_tokenId1) == msg.sender || ownerOf(_tokenId2) == msg.sender, "You can't send the Star you don't owned");
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        address ownerAddress = ownerOf(_tokenId);
        require(ownerOf(_tokenId) == msg.sender, "You can't send the Star you don't owned");
